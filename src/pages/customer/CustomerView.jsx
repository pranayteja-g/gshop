...
export default function CustomerView() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', maxWidth: '500px', margin: '0 auto' }}>
      ...
      {/* Grid */}
      <div style={{ padding: '0.8rem', display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '0.7rem' }}>
        {filtered.length === 0 && (
